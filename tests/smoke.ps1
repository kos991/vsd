...
Assert-FileContains '.github/workflows/build-ova.yml' 'dist/ci-context\.txt' 'Workflow must preserve CI context for diagnosing pre-build failures.'
Assert-FileContains '.github/workflows/build-ova.yml' 'dist/smoke\.log' 'Workflow must preserve smoke test output when template checks fail.'
