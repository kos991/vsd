...
Assert-FileContains 'scripts/build-debian-ova.sh' 'virt_args\+=\(--run /root/dae-gateway-build/setup-debian-gateway\.sh\)' 'Debian build must run guest setup in the same virt-customize transaction as file uploads.'
