...
Assert-FileContains '.github/workflows/build-ova.yml' 'path: \$\{\{ github\.workspace \}\}/dist' 'Workflow must upload the workspace dist directory so failure logs are included.'
