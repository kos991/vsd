...
Assert-FileContains 'overlay/usr/local/sbin/dae-manager' 'start_service' 'dae manager must wrap start so stale OpenRC state can be recovered.'
Assert-FileContains 'overlay/usr/local/sbin/dae-manager' 'rc-service "\$service_name" zap' 'dae manager must clear stale OpenRC started state before retrying a stopped service.'
